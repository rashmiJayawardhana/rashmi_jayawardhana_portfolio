...
// Inline SVG icons drawn with currentColor, so they inherit the surrounding text colour and hover states.

export const GithubIcon = ({className = 'w-5'}) => (
...
export const LinkedinIcon = ({className = 'w-5'}) => (
  <svg viewBox='0 0 24 24' className={className} fill='currentColor' aria-hidden='true'>
